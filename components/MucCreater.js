  ...
  render() {
    ...
    return(
        <View style={styles.container}>
          ...
          } onPress={()=> {{xmpp.createInterpretationMuc = false} xmpp.createConference(this.state.name, xmpp.mucSubject, xmpp.newMucParticipants, this.state.username); this.setState({topic:'', name:''}); Actions.tabbar({type:ActionConst.RESET}); Actions.groupTab(); Actions.groupConversation()} }>Create conference</Button>
